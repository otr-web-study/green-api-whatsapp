...
import { useNewRecipient } from '../hooks/useNewRecipient';
import { useRecipientControls } from '../hooks/useRecipientsControls';

const NewRecipient = () => {
  const { recipient, title, onRecipientChange, onTitleChane, addClick } = useNewRecipient();
  ...
  return (
    <>
      <div className="w-full h-[123px] px-4 flex justify-start items-end bg-bg_stripe_deeper">
        ...
        <p className="pb-5 ml-6 text-white text-xl">New recipient</p>
      </div>
